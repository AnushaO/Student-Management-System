                    ...
                    <tbody>
                        @foreach($teachers as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('teacher.show', $item->id) }}" title="View Teacher">
                                        <button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button>
                                    </a>
                                    <a href="{{ route('teacher.edit', $item->id) }}" title="Edit Teacher">
                                        <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button>
                                    </a>

                                    <form method="POST" action="{{ route('teacher.destroy', $item->id) }}" style="display:inline">
                                        @method('DELETE')
                                        @csrf
